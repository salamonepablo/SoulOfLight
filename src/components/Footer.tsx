      ...
      <div className="px-4 pb-8 py-2 w-full">
        ...
        <div className="mx-auto max-w-5xl w-full">
          ...
          <div className="rounded-full border border-emerald-800/20 bg-white text-slate-700 px-6 py-1 flex flex-wrap items-center justify-between shadow-sm">
            ...
            <Link
              href="https://instagram.com/almadeluz.sahumerios"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-emerald-700 flex items-center gap-2 group transition-all"
            >
              <IoLogoInstagram
                size={22}
              ...
              {/* Oculta texto en móviles muy chicos si es necesario */}
            </Link>

            {/* Elemento 3: Instagram 2 */}
            <Link
              href="https://instagram.com/almadeluz71"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-emerald-700 flex items-center gap-2 group transition-all"
            >
            ...
            {/* Elemento 4: Mail */}
            <a
              href="mailto:almadeluz@gmail.com"
              className="hover:text-emerald-700 flex items-center gap-2 group transition-all"
            >
              <IoMdMail
                size={22}
                className="text-slate-500 group-hover:text-emerald-700 transition-colors"
              />
